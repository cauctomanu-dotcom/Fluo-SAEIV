...
(()=>{
  ...
  function tidyMenu(){
    ...
    for(const id of ['v135JournalBtn','v13JournalBtn','v136VehicleBtn','v136ContactsBtn','v136EndDayBtn','v316PlanningBtn','v26MyTadsBtn','v304MyCollectivesBtn','v108CashBtn']){const el=q(id);if(el)el.style.setProperty('display','none','important')}
  }
